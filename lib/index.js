 ...
 * @desc 创建交易
 **/
BlockchainSdk.prototype.createTx = async function (privateKey, recipient, amount, fee, contract, data, nonce, rate) {
	return this.sdk.createTx(privateKey, recipient, amount, fee, contract, data, nonce, rate)
}
...
BlockchainSdk.prototype.unsign = function (rawTransaction) {
	return this.sdk.unsign(rawTransaction)
}

BlockchainSdk.prototype.getErc20InfoFromInput = function (tx) {
	return this.sdk.getErc20InfoFromInput(tx)

}

BlockchainSdk.prototype.getErc20TransferFee = async function (contract, from, recipient, amount) {
	return this.sdk.getErc20TransferFee(contract, from, recipient, amount)

}

BlockchainSdk.prototype.getErc20TxArr = async function (tx) {
	return this.sdk.getErc20TxArr(tx)

}
BlockchainSdk.prototype.getTransaction = function (hash) {
	return this.sdk.getTransaction(hash)
}
...
BlockchainSdk.prototype.getAverageFee = function (to, data) {
	return this.sdk.getAverageFee(to, data)
}
// eth独有接口
